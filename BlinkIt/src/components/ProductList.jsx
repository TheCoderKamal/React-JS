            ...
            <div className="grid grid-cols-6 gap-4 my-[25px] mt-[15px]">
                {
                    ...
                    data1.map((element, index) => {
                        return (
                            <div className="border rounded-xl overflow-hidden px-3 pb-[20px] shadow-sm hover:scale-105 duration-300 hover:boxshadow hover:-translate-x-1 hover:-translate-y-1 " key={index}>
