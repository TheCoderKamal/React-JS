...
export default function OurclassNamees() {
    return (
        <>
            <section classNameName="section" id="our-classNamees">
                    ...
                    <div classNameName="row" id="tabs">
                        <div classNameName="col-lg-4">
                            <ul>
                                ...
                                <div classNameName="main-rounded-button"><a href="#">View All Schedules</a></div>
                            </ul>
                        </div>
                        <div classNameName="col-lg-8">
                            <section classNameName='tabs-content'>
                                <article id='tabs-1'>
